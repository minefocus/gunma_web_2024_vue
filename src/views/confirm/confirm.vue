<template>
  <div style="width:100%;padding-bottom:50px">
    ...
    <el-row>
      <el-col :xs="0" :sm="24" style="">
        <div style="width:100%;height:100%;overflow: hidden;display:flex;justify-content: center;">
          <img style="width: 100%;height:100%" class="rending_img" src="@/assets/steps/step_pc_05@3x.png" alt="">
        </div>
      </el-col>
    </el-row>
    <el-row>
      <el-col :xs="24" :sm="0" style="">
        <div style="width:100%;height:100%;overflow: hidden;display:flex;justify-content: center;">
          <img style="width: 100%;height:100%" class="rending_img" src="@/assets/steps/step_05@3x.png" alt="">
        </div>
    ...
    <el-row>
      <el-col :span="24" class="confirm_waring">
        ご入力内容をご確認いただき、よろしければ「この内容で申込む」ボタンを押してください。<br>
        ご入力いただいた内容を修正される場合は、「修正」ボタンを押してください。
      </el-col>
    </el-row>
    <div style="width:100%;margin-top:15px" class="back_img_">
      <el-row class="border_ margin_1 mobile_margin back_all flex_center_web">
        <el-col :xs="24" :sm="6" class="border_r">
          <div class="tittle_out flex_center">
            <span class="flex_title font_w">お客さま情報</span>
          </div>
        </el-col>
            ...
            <el-row class="flex_bet">
              <el-col :xs="24" :sm="24">
                <el-row class="first_title">
                  <el-col :xs="24" :sm="24" style="display: flex;justify-content: space-between;">
                    <div class="flex_center">
                      <span class="font_weight_bold">お名前（フリガナ）</span>
                    </div>
                ...
                <el-row class="second_title">
                  <el-col :xs="24" :sm="24" style="display: flex;justify-content: space-between;">
                    <div class=" ">
                      <span  style="margin-right:20px">メイ</span>
            ...
            <el-row class="flex_bet">
              <el-col :xs="24" :sm="24">
                <el-row class="first_title">
                  <el-col :xs="24" :sm="24">
                    <div class="">
                      <span class="font_weight_bold">性别</span>
                    </div>
                  </el-col>
                </el-row>
            ...
            <el-row class="flex_bet">
              <el-col :xs="24" :sm="24">
                <el-row class="first_title">
                  <el-col :xs="24" :sm="24">
                    <div class="">
                      <span class="font_weight_bold">生年月日</span>
                    </div>
                  </el-col>
                </el-row>
            ...
            <el-row class="flex_bet">
              <el-col :xs="24" :sm="24">
                <el-row class="first_title">
                  <el-col :xs="24" :sm="24" style="display: flex;justify-content: space-between;">
                    <div class="">
                      <span class="font_weight_bold">電話番号</span>
                    </div>
            ...
            <el-row class="flex_bet">
              <el-col :xs="24" :sm="24">
                <el-row class="first_title">
                  <el-col :xs="24" :sm="24">
                    <div class=" ">
                      <span class="font_weight_bold">ご職業</span>
                    </div>
                  </el-col>
                </el-row>
                <el-row class="third_text">
                  <el-col :xs="24" :sm="24" class="">
                    <div v-for="item in pageF.checkList" :key="item" style="margin-bottom: 10px">{{item|Job| NOVALUE}}
                      <span v-if="item=='11'">&nbsp;&nbsp;({{pageF.other_item | NOVALUE}})</span></div>
            ...
            <el-row class="flex_bet">
              <el-col :xs="24" :sm="24">
                <el-row class="first_title">
                  <el-col :xs="24" :sm="24">
                    <div class=" ">
                      <span class="font_weight_bold">お勤め先電話番号</span>
                    </div>
                  </el-col>
                </el-row>
                <el-row class="third_text">
      ...
      <!-- -------------- -->
      <el-row class="row_height_650px border_ margin_1 mobile_margin  back_all flex_center_web">
        <el-col :xs="24" :sm="6" class="border_r">
            ...
            <el-row class="flex_bet">
              <el-col :xs="24" :sm="24">
                ...
                <el-row class="first_title" >
                  <el-col :xs="24" :sm="24" style="display: flex;justify-content: space-between;">
                    <div class="m_15px">
                      <span class="font_weight_bold">キャッシュカード情報入力</span>
                    </div>
                  </el-col>
                </el-row>
                ...
                <el-row class="second_title">
                  <el-col :xs="24" :sm="24" style="display: flex;justify-content: space-between;">
                    <div class=" ">
                      <span class="" style="">キャッシュカード暗証番号</span>
                    </div>
                  </el-col>
                </el-row>
                <el-row class="third_text">
  ...
  <el-row style="height: 90px;">
      <el-col :xs="24" :sm="24" class="flex_center">
         ...
         <van-button class="flex_center button_All  position_R" type="primary"  @click="confirmData()" >
          <span>この内容で申込む</span>
...
export default {
  ...
  methods: {
   ...
   if(!isEmpty(decrypt(this.$store.state.user.tele_number01))&&!isEmpty(decrypt(this.$store.state.user.tele_number02))&&!isEmpty(decrypt(this.$store.state.user.tele_number03))){
          tele_number = decrypt(this.$store.state.user.tele_number01) + "-" + decrypt(this.$store.state.user.tele_number02) + "-"+ decrypt(this.$store.state.user.tele_number03)
        }	
    if(!isEmpty(decrypt(this.$store.state.user.phone_number01))&&!isEmpty(decrypt(this.$store.state.user.phone_number02))&&!isEmpty(decrypt(this.$store.state.user.phone_number03))){
     phone_number=  decrypt(this.$store.state.user.phone_number01) + "-"+  decrypt(this.$store.state.user.phone_number02) + "-"+ decrypt(this.$store.state.user.phone_number03)
    }
     if(!isEmpty(decrypt(this.$store.state.user.work_tele_number01))&&!isEmpty(decrypt(this.$store.state.user.work_tele_number02))&&!isEmpty(decrypt(this.$store.state.user.work_tele_number03))){
     work_tele_number= decrypt(this.$store.state.user.work_tele_number01) + "-"+ decrypt(this.$store.state.user.work_tele_number02) + "-" + decrypt(this.$store.state.user.work_tele_number03)
    }
      ...
      startLoading()
      ACCOUNT_APPLICATION_POST(data).then((res) => {
       
        endLoading()
        if (res.success) {
          this.$router.push({name: 'finish',params: {custome_id:res.data.seq_no}})
        }else{
          if(res.message.open_message_type !=='pop'){
    ...
    getState() {
     this.pageF.name_first = decrypt(this.$store.state.user.name_first);
      ...
      this.pageF.kana_last_name = decrypt(this.$store.state.user.kana_last_name);
      this.pageF.kana_first_name = decrypt(this.$store.state.user.kana_first_name);
      this.pageF.address_city = decrypt(this.$store.state.user.address_city);
      this.pageF.address_number = decrypt(this.$store.state.user.address_number);
      ...
      this.pageF.kana_address_other = decrypt(this.$store.state.user.kana_address_other);
      ...
      this.pageF.phone_number01 = decrypt(this.$store.state.user.phone_number01);
      this.pageF.phone_number02 = decrypt(this.$store.state.user.phone_number02);
      this.pageF.phone_number03 = decrypt(this.$store.state.user.phone_number03);
      if(!isEmpty(this.pageF.phone_number01)&&!isEmpty(this.pageF.phone_number02)&&!isEmpty(this.pageF.phone_number03)){
        this.pageF.phone_number_content = this.pageF.phone_number01+'-'+this.pageF.phone_number02+'-'+this.pageF.phone_number03
      }else{
      ...
      if(!isEmpty(this.pageF.tele_number)&&!isEmpty(this.pageF.tele_number_02)&&!isEmpty( this.pageF.tele_number_03)){
          this.pageF.tele_number_content = this.pageF.tele_number + "-" + this.pageF.tele_number_02 + "-"+ this.pageF.tele_number_03
      }else{
          this.pageF.tele_number_content =''
      }
      this.pageF.checkList = decrypt(this.$store.state.user.job_kbn)==''?[]:JSON.parse(decrypt(this.$store.state.user.job_kbn));
      ...
      this.pageF.work_tele_number01 = decrypt(this.$store.state.user.work_tele_number01);
      this.pageF.work_tele_number02 = decrypt(this.$store.state.user.work_tele_number02);
      this.pageF.work_tele_number03 = decrypt(this.$store.state.user.work_tele_number03);

      if(!isEmpty(this.pageF.work_tele_number01)&&!isEmpty(this.pageF.work_tele_number02)&&!isEmpty(this.pageF.work_tele_number03)){
      this.pageF.work_tele_number_content = this.pageF.work_tele_number01 + "-"+ this.pageF.work_tele_number02 + "-" + this.pageF.work_tele_number03
      }else{
      ...
      this.pageS.account_store_number = decrypt(this.$store.state.user.account_store_number);
      this.pageS.account_store_nm = decrypt(this.$store.state.user.account_store_nm);
      ...
      this.pageS.security_password = decrypt(this.$store.state.user.security_password);
      this.pageS.security_password02 = decrypt(this.$store.state.user.security_password02);
      this.pageS.contractor_flg = decrypt(this.$store.state.user.contractor_flg);

      this.pageS.creditlimit = decrypt(this.$store.state.user.creditlimit);
      this.pageS.online_password = decrypt(this.$store.state.user.online_password);
      this.pageS.online_password02 = decrypt(this.$store.state.user.online_password02);

      this.pageS.checklist =  decrypt(this.$store.state.user.account_purpose)==''?[]:JSON.parse(decrypt(this.$store.state.user.account_purpose));
      this.pageS.account_reason =  decrypt(this.$store.state.user.account_reason);

      this.pageS.account_purpose_other = decrypt(this.$store.state.user.account_purpose_other);
      this.pageS.account_reason_other = decrypt(this.$store.state.user.account_reason_other);
