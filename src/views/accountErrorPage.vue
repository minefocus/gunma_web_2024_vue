...
<div class="top_div" style="font-size:14px">
    ...
    <div style="width:100%;height:25px;background:red;color: white;" class="flex_start_err_tittle">
      エラーが発生しました。
    </div>
     
    <div class="back_">
    <div style="width: 100%;color: red;overflow: hidden;word-break: break-all;padding: 0 10px;" v-html='error_message'>
...
<div class="position_B flex_c" style="width:100%">
    <div class="f_c_s" style="width:100%;line-height: 25px;margin-bottom: 100px;">
        <div style="overflow: hidden;word-break: break-all;padding:0 10px;font-weight: bolder;border: 1px solid black;">
        阿波銀行　あわぎんお客さまサポートセンター<br>
                0120-39-8689<br>
            平日 9:00～17:00
    </div>
    </div>
