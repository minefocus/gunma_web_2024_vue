export const MESSAGE = {
    ...
    MsgErrCheck029: 'お名前（漢字）の名は全角10文字まで入力してください',
    ...
    MsgErrCheck093: '電話番号の形式が正しくありません',
    MsgErrCheck094: '携帯電話番号と自宅電話番号は、それぞれ違う電話番号を入力してください。',
    MsgErrCheck095: 'お名前（フリガナ）のセイは20文字まで入力してください',
    MsgErrCheck096: 'お勤め先（学校名）は全角10文字まで入力してください',
