export const MESSAGE = {
    ...
    MsgErrCheck026: 'お名前（漢字）を入力してください',
    MsgErrCheck027: 'お名前（漢字）はそれぞれ全角15文字までで入力してください',
    MsgErrCheck028: 'お名前（漢字）を入力してください',
    MsgErrCheck029: 'お名前（漢字）はそれぞれ全角15文字までで入力してください',
    MsgErrCheck030: 'お名前（フリガナ）を入力してください',
    MsgErrCheck031: 'お名前（フリガナ）はそれぞれ全角カナ15文字までで入力してください',
    MsgErrCheck032: 'お名前（フリガナ）を入力してください',
    MsgErrCheck033: '生年月日を入力してください', 
    MsgErrCheck034: '性別を選択してください', 
    MsgErrCheck035: '郵便番号を入力してください', 
    MsgErrCheck036: '郵便番号は半角数字7桁で入力してください', 
    MsgErrCheck037: '都道府県を選択してください', 
    MsgErrCheck038: '市区町村を入力してください', 
    MsgErrCheck039: '市区町村は全角20文字までで入力してください', 
    ...
    MsgErrCheck052: 'お勤め先電話番号は半角数字10-11桁で入力してください',
    ...
    MsgErrCheck061: 'キャッシュカード暗証番号を入力してください',  

    MsgErrCheck062: 'キャッシュカード暗証番号は半角数字4桁で入力してください',   
    MsgErrCheck063: 'キャッシュカード暗証番号（確認）を入力してください',   
    MsgErrCheck064: 'キャッシュカード暗証番号（確認）は半角数字4桁で入力してください', 
    MsgErrCheck065: 'キャッシュカード暗証番号の入力内容が一致していません', 
    MsgErrCheck066: '1日あたりの振込限度額を入力してください', 
    MsgErrCheck067: '1日あたりの振込限度額は0～1000000の範囲で入力してください', 

    MsgErrCheck068: 'インターネットバンキング暗証番号を入力してください', 
    MsgErrCheck069: 'インターネットバンキング暗証番号は半角数字6桁で入力してください',
    MsgErrCheck070: 'インターネットバンキング暗証番号（確認）を入力してください',
    MsgErrCheck071: 'インターネットバンキング暗証番号（確認）は半角数字6桁で入力してください	',
    MsgErrCheck072: 'インターネットバンキング暗証番号の入力内容が一致していません',	
